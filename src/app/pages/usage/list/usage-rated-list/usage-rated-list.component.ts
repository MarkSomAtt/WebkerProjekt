...
@Component({
  selector: 'app-usage-rated-list',
  templateUrl: './usage-rated-list.component.html',
  styleUrls: ['./usage-rated-list.component.scss']
})
export class UsageRatedListComponent implements OnInit {
  title = 'Rated';

...
@Component({
  selector: 'app-usage-received-list',
  templateUrl: './usage-received-list.component.html',
  styleUrls: ['./usage-received-list.component.scss']
})
export class UsageReceivedListComponent implements OnInit {
  title = 'Received';
